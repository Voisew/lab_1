...
# Главное меню программы
Действия, связанные с управлением файлами:
...
Сохранить как…  – Сохранение файла под новым именем или в другом формате.
Выход  – Закрытие программы (предлагает сохранить изменения, если они есть).
Правка:
Операции с текстом/объектами:
Отменить  – Отмена последнего действия.
Повторить  – Возврат отменённого действия.
Вырезать  – Удаление выделенного фрагмента с помещением в буфер обмена.
Копировать  – Копирование выделенного фрагмента в буфер обмена.
Вставить  – Вставка содержимого буфера обмена.
Удалить  – Удаление выделенного фрагмента (без сохранения в буфере).
Выделить все  – Выделение всего содержимого документа/области.
# Вызов справки
